...
Tutkimukseen perustuvat edistyneet tekniikat.

## Tekniikat

| Technique | File | Usage |
|-----------|----------|--------|
| Chain-of-Thought | [chain-of-thought.md](chain-of-thought.md) | Complex reasoning |
| Self-Consistency | [self-consistency.md](self-consistency.md) | Luotettavammat vastaukset |
