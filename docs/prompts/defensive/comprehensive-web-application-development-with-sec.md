...
**Category:** defensive
**Source:** prompts.chat (contributor: @damimehdi20@gmail.com)

## When to Use

Use this prompt when you need an AI to act as a comprehensive web application development with security and performance optimization.
